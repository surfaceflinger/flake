...

{
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = [ "org.gnome.Nautilus.desktop" "com.raggesilver.BlackBox.desktop" "google-chrome.desktop" "org.telegram.desktop.desktop" "discord.desktop" "slack.desktop" "timedoctor-desktop.desktop" "org.gnome.Geary.desktop" "org.gnome.Lollypop.desktop" "code.desktop" "org.gabmus.gfeeds.desktop" "org.prismlauncher.PrismLauncher.desktop" "lunar-client.desktop" "steam.desktop" "pavucontrol.desktop" "virt-manager.desktop" "org.qbittorrent.qBittorrent.desktop" "ledger-live-desktop.desktop" ];
    };
