{
  ...
  inputs = {
    ...
    cfn-changeset-viewer.url = "github:trek10inc/cfn-changeset-viewer/main";
    ...
    monero-banlist.flake = false;
    monero-banlist.url = "github:rblaine95/monero-banlist/master";
